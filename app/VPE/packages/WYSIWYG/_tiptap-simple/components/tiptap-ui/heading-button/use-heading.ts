...
import {
  ...
  isNodeTypeSelected,
  isValidPosition,
} from "@VPE/packages/WYSIWYG/_tiptap-simple/lib/tiptap-utils"

// --- Icons ---
import { HeadingOneIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@VPE/packages/WYSIWYG/_tiptap-simple/components/tiptap-icons/heading-six-icon"
