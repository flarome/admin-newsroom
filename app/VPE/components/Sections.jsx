...
import { Icon, Text, Box } from "@shopify/polaris";
      ...
      {generaleGroup && generaleGroup.props?.length > 0 && (
        <>
          {(generaleGroup.props || []).map((field) => (
            <div key={field.name} className="_Setting_1igpc_1 _DenseSetting_1igpc_15">
              <Fields
                field={field}
                onCommit={(name, value) =>
                  onOneSectionIsUpdated(
        ...
        <React.Fragment key={group.name}>
          <div className="_Setting_1igpc_1 _DenseSetting_1igpc_15">
            <div className="_Header_1igpc_21 _withBorder_1igpc_28">
              ...
              >
                <h3
                  className="Polaris-Text--root Polaris-Text--headingSm Polaris-Text--breakAlways"
                  tabIndex={-1}
                >
