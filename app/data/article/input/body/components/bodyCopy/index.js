import {
  ...
  header_config,
  header_props,
  secondaryheader_body,
  secondaryheader_copy,
  secondaryheader_config,
  secondaryheader_props,
...
export const blocks = [
  ...
  },
  {
    ...
    {
    title: secondaryheader_config.title,
    type: secondaryheader_config.type,
    props: Object.values(secondaryheader_props),
  },
];
    ...
    switch (block.type) {
      ...
      case header_config.type:
        return header_body(block);
           case secondaryheader_config.type:
        return secondaryheader_body(block);
    }
  });
    ...
    switch (block.type) {
      ...
      case header_config.type:
        return header_copy(block);
         ...
         case secondaryheader_config.type:
        return secondaryheader_copy(block);
    }
  });
  return content;
}
