      ...
      >
        ...
        >
          ...
          >
            ...
            {url && isPublished && (
              <span>
                <a href={url + "?view=" + template} data-polaris-unstyled="true" className="Polaris-Button Polaris-Button--pressable Polaris-Button--variantTertiary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter Polaris-Button--iconOnly" target="_blank" rel="noopener noreferrer" tabIndex="0" aria-describedby=":r6v:" data-polaris-tooltip-activator="true">
                  <span className="Polaris-Button__Icon">
                    <span className="Polaris-LegacyIcon__Icon">
                      <span aria-hidden="true" className="Polaris-LegacyIcon__SvgSmScreen">
                      ...
                      <span aria-hidden="true" className="Polaris-LegacyIcon__SvgLgScreen">
          ...
          >
            <div>
              <Select label="Modèle de thème" options={options} onChange={handleSelectChange} value={template} />
            </div>
          </div>
        </div>
      </div>
