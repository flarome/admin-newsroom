...
export const DeleteModalProvider = ({ isDelete, children }) => {
  const { article, hasArticle } = useArticle();

  const shopify = useAppBridge();



  const [open, setOpen] = useState(isDelete || window.location.pathname.endsWith("/delete"));
 ...
 window.history.pushState({}, "", window.location.pathname.replace(/\/delete$/, ""));
  }, [shopify]);
